...
from projects.models import Ort,Bezirk

os.system('rm /tmp/re_bplan.json')
os.system('ogr2ogr -s_srs EPSG:25833 -t_srs WGS84 -f geoJSON /tmp/re_bplan.json WFS:"http://fbinter.stadt-berlin.de/fb/wfs/geometry/senstadt/re_bplan" re_bplan');
...
for feature in data["features"]:    
    ...
    url = "http://nominatim.openstreetmap.org/reverse?format=json&lat=" + lat + "&\

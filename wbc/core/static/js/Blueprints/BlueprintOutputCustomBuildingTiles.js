...
(function() {
  ...
  VIZI.BlueprintOutputCustomBuildingTiles = function(options) {
    ...
    _.defaults(self.options.highlightMaterialOptions, {
      color: 0xeeee00,
      ambient: 0xff00ff,
      emissive: 0xc00ccc,
      shading: THREE.FlatShading
  ...
  VIZI.BlueprintOutputCustomBuildingTiles.prototype = Object.create( VIZI.BlueprintOutput.prototype );

  // Initialise instance and start automated processes
  VIZI.BlueprintOutputCustomBuildingTiles.prototype.init = function() {
    var self = this;
  ...
  VIZI.BlueprintOutputCustomBuildingTiles.prototype.createGrid = function(gridOptions) {
    var self = this;
  ...
  VIZI.BlueprintOutputCustomBuildingTiles.prototype.outputBuildingTile = function(buildings, tile) {
    if (!buildings.length) {
        return;
    }
  ...
  VIZI.BlueprintOutputCustomBuildingTiles.prototype.outputBuildingTileWorker = function(origin, originZoom, options, buildings) {
    var self = this;
    ...
    //   materialType = "MeshLambertMaterial";
    // }
      // var material = new THREE['MeshLambertMaterial'](options.materialOptions);

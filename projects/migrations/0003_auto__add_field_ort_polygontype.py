...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ort.polygontype'
        db.add_column(u'projects_ort', 'polygontype',
                      self.gf('django.db.models.fields.TextField')(default='Polygon'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ort.polygontype'
        db.delete_column(u'projects_ort', 'polygontype')
    ...
    models = {
        ...
        u'projects.ort': {
            ...
            'polygontype': ('django.db.models.fields.TextField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {})
        },
